    ...
    ************************************/
    ...
    (function (factory) {
        ...
        return moment.lang('ar', {
            months: "ÙÙ†Ø§ÙØ±/ ÙƒØ§Ù†ÙˆÙ† Ø§Ù„Ø«Ø§Ù†Ù_ÙØ¨Ø±Ø§ÙØ±/ Ø´Ø¨Ø§Ø·_Ù…Ø§Ø±Ø³/ Ø¢Ø°Ø§Ø±_Ø£Ø¨Ø±ÙÙ„/ Ù†ÙØ³Ø§Ù†_Ù…Ø§ÙÙˆ/ Ø£ÙØ§Ø±_ÙÙˆÙ†ÙÙˆ/ Ø­Ø²ÙØ±Ø§Ù†_ÙÙˆÙ„ÙÙˆ/ ØªÙ…ÙˆØ²_Ø£ØºØ³Ø·Ø³/ Ø¢Ø¨_Ø³Ø¨ØªÙ…Ø¨Ø±/ Ø£ÙÙ„ÙˆÙ„_Ø£ÙƒØªÙˆØ¨Ø±/ ØªØ´Ø±ÙÙ† Ø§Ù„Ø£ÙˆÙ„_Ù†ÙˆÙÙ…Ø¨Ø±/ ØªØ´Ø±ÙÙ† Ø§Ù„Ø«Ø§Ù†Ù_Ø¯ÙØ³Ù…Ø¨Ø±/ ÙƒØ§Ù†ÙˆÙ† Ø§Ù„Ø£ÙˆÙ„".split("_"),
            monthsShort: "ÙÙ†Ø§ÙØ±/ ÙƒØ§Ù†ÙˆÙ† Ø§Ù„Ø«Ø§Ù†Ù_ÙØ¨Ø±Ø§ÙØ±/ Ø´Ø¨Ø§Ø·_Ù…Ø§Ø±Ø³/ Ø¢Ø°Ø§Ø±_Ø£Ø¨Ø±ÙÙ„/ Ù†ÙØ³Ø§Ù†_Ù…Ø§ÙÙˆ/ Ø£ÙØ§Ø±_ÙÙˆÙ†ÙÙˆ/ Ø­Ø²ÙØ±Ø§Ù†_ÙÙˆÙ„ÙÙˆ/ ØªÙ…ÙˆØ²_Ø£ØºØ³Ø·Ø³/ Ø¢Ø¨_Ø³Ø¨ØªÙ…Ø¨Ø±/ Ø£ÙÙ„ÙˆÙ„_Ø£ÙƒØªÙˆØ¨Ø±/ ØªØ´Ø±ÙÙ† Ø§Ù„Ø£ÙˆÙ„_Ù†ÙˆÙÙ…Ø¨Ø±/ ØªØ´Ø±ÙÙ† Ø§Ù„Ø«Ø§Ù†Ù_Ø¯ÙØ³Ù…Ø¨Ø±/ ÙƒØ§Ù†ÙˆÙ† Ø§Ù„Ø£ÙˆÙ„".split("_"),
        ...
        function translate(number, withoutSuffix, key, isFuture) {
            ...
            switch (key) {
                case 's':  // a few seconds / in a few seconds / a few seconds ago
                    return (withoutSuffix || isFuture) ? 'pĂ¡r vteÅ™in' : 'pĂ¡r vteÅ™inami';
    ...
    (function (factory) {
        ...
        function processRelativeTime(number, withoutSuffix, key, isFuture) {
            var format = {
                ...
                'MM': [number + ' MĂ©int', number + ' MĂ©int'],
         ...
         * e.g. "Leschten DĂ«nschdeg" but "Leschte MĂ©indeg"
         *
        ...
        function eifelerRegelAppliesToWeekday(weekday) {
            ...
            switch (weekday) {
                ...
                case 6: // Samschdeg
                    return true;
                default: // 2 DĂ«nschdeg, 4 Donneschdeg
                    return false;
            }
        }
    ...
    (function (factory) {
        ...
        return moment.lang('nn', {
            ...
            calendar: {
                ...
                lastWeek: '[FĂ¸regĂ¥ende] dddd [klokka] LT',
                sameElse: 'L'
            },
            relativeTime: {
                future: "om %s",
    ...
    (function (factory) {
        ...
        return moment.lang('sq', {
            ...
            weekdays: "E Diel_E HĂ«nĂ«_E Marte_E MĂ«rkure_E Enjte_E Premte_E ShtunĂ«".split("_"),
